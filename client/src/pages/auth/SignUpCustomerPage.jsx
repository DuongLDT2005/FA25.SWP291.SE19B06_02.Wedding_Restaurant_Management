  ...
  return (
    <AuthLayout>
      ...
      >
        ...
        <div className="signup-card" style={{ maxWidth: "1000px", width: "100%" }}>
          <div
            style={{
          ...
          >
            ...
            <p style={{ fontSize: "18px", margin: "0", lineHeight: "1.5" }}>
              Câu chuyện tình cảm của bạn xứng đáng được ghi khắc lại. Hãy để chúng tôi giúp bạn biến ngày trọng đại của
              bạn thành một kỷ niệm không thể nào quên.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Form.Select
                  ...
                  onChange={(e) => {
                    ...
                    setForm({
                      ...form,
                      role,
                      partner: role === "Cô dâu" || role === "Chú rể" ? form.partner : "",
                    })
                  }}
              ...
              {(form.role === "Cô dâu" || form.role === "Chú rể") && (
                <Form.Group className="mb-3">
                  ...
                  />
                  <Form.Control.Feedback type="invalid">{errors.partner}</Form.Control.Feedback>
                </Form.Group>
              )}
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control.Feedback type="invalid" style={{ display: errors.confirmPassword ? "block" : "none" }}>
